...
The results for the NT time range showed no significant main effect of group (`r learn.Extd.ColNt.results$full_result$Group1`), no main effect of session(`r learn.Extd.ColNt.results$full_result$Session`), however there was a significant main effect of electrode laterality reflecting an increased negativity at contralateral electrodes compared to ipsilateral electrodes (`r learn.Extd.ColNt.results$full_result$Contra`). There was no significant interaction between group and electrode laterality (`r learn.Extd.ColNt.results$full_result$Group1_Contra`), no significant interaction between group and sesssion (`r learn.Extd.ColNt.results$full_result$Group1_Session`), no significant interaction between laterality and session (`r learn.Extd.ColNt.results$full_result$Contra_Session`), and no significant three-way interaction between group, laterality, and session (`r learn.Extd.ColNt.results$full_result$Group1_Contra_Session`). 

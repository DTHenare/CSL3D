...
srch.rt.init.fup <- apa_print.emmGrid(pairs(emmeans(srch.rt.init.aov, ~CompCond|InitSess)))
...
srch.rt.extd.initxComp.fup <- apa_print.emmGrid(pairs(emmeans(srch.rt.extd.aov, ~CompCond|InitSess)))
srch.rt.extd.SessxComp.fup <- apa_print.emmGrid(pairs(emmeans(srch.rt.extd.aov, ~CompCond|Session)))
...
srch.rt.retr.fup <- apa_print.emmGrid(pairs(emmeans(srch.rt.retr.aov, ~CompCond|FinSess)))
...
```{r saveBehavData}
save(cat.acc.init.aov, cat.rt.init.aov, srch.acc.init.aov, srch.rt.init.aov,distint.init.aov, cat.acc.extd.aov, cat.rt.extd.aov, srch.acc.extd.aov, srch.rt.extd.aov, distint.extd.aov, distint.extd.posthoc, cat.acc.retr.aov, cat.rt.retr.aov, srch.acc.retr.aov, srch.rt.retr.aov, distint.retr.aov, srch.rt.init.fup, srch.rt.extd.initxComp.fup, srch.rt.extd.SessxComp.fup, srch.rt.retr.fup, file = "DataOutput/behavANOVAs.RData")
```
...
behavData %>%
  ...
  theme_apa()
ggsave("Figures/Behav1.tiff", dpi = 300, width = 16, height = 8, units = "cm")
...
behavData %>%
  ...
  theme_apa()
ggsave('Figures/Behav2.tiff', dpi = 300, width = 16, height = 8, units = "cm")
...
behavData %>%
  ...
  coord_cartesian(ylim=c(75,100))+
  theme_apa()
ggsave('Figures/Behav3.tiff', dpi = 300, width = 16, height = 8, units = "cm")
...
ggsave('Figures/Behav4.tiff', dpi = 300, width = 16, height = 8, units = "cm")
...
save(learn.Init.ColNt.results, learn.Init.ShpNt.results, learn.Init.ColPd.results, learn.Init.ShpPd.results, learn.Init.ColNt.fup, learn.Init.ShpNt.fup, learn.Init.ColPd.fup, learn.Init.ColNt.aov, learn.Init.ShpNt.aov, learn.Init.ColPd.aov, learn.Init.ShpPd.aov, file = "DataOutput/lernInitERPANOVAs.RData")
```
...
ggsave("Figures/lernInitERPs.tiff", dpi = 300, width = 16, height = 8, units = "cm")
```
...
learn.Extd.ShpNt.fup.ContraGroup1 <- apa_print.emmGrid(pairs(emmeans(learn.Extd.ShpNt.aov, ~Contra|Group1)))
learn.Extd.ShpNt.fup.ContraSession <- apa_print.emmGrid(pairs(emmeans(learn.Extd.ShpNt.aov, ~Contra|Session)))
```
...
save(learn.Extd.ColNt.results, learn.Extd.ShpNt.results, learn.Extd.ColPd.results, learn.Extd.ShpPd.results, learn.Extd.ShpNt.fup.ContraGroup1, learn.Extd.ShpNt.fup.ContraSession, learn.Extd.ColNt.aov, learn.Extd.ShpNt.aov, learn.Extd.ColPd.aov, learn.Extd.ShpPd.aov, file = "DataOutput/lernExtdERPANOVAs.RData")
```
...
allData %>%
    ...
    scale_x_continuous(name ="Latency (ms)", expand = c(0, 0), limits=c(-200, 500), breaks=seq(-200,500,200)) +
    scale_y_reverse(name =expression(paste("Amplitude (",mu,"v)")), expand = c(0, 0)) +
    facet_grid(Stimulus~Group1) +
    theme_apa()+
    theme(text = element_text(size=10),
          legend.text = element_text( size = 4),
          legend.title = element_text( size = 4))
ggsave("Figures/lernExtdERPs.tiff", dpi = 300, width = 16, height = 8, units = "cm")
```
...
learn.Retr.ColNt.fup <- apa_print.emmGrid(pairs(emmeans(learn.Retr.ColNt.aov, ~Contra|Group2)))
grandTarget <- allData %>%
...
save(learn.Retr.ColNt.results, learn.Retr.ShpNt.results, learn.Retr.ColPd.results, learn.Retr.ShpPd.results, learn.Retr.ColNt.fup, learn.Retr.ColNt.aov, learn.Retr.ShpNt.aov, learn.Retr.ColPd.aov, learn.Retr.ShpPd.aov,  file = "DataOutput/lernRetrERPANOVAs.RData")
```
...
allData %>%
    ...
    scale_x_continuous(name ="Latency (ms)", expand = c(0, 0), limits=c(-200, 500), breaks=seq(-200,500,200)) +
    scale_y_reverse(name =expression(paste("Amplitude (",mu,"v)")), expand = c(0, 0)) +
    facet_grid(Stimulus~Group2) +
    theme_apa()+
    theme(legend.text = element_text( size = 4),
          legend.title = element_text( size = 4),
          text = element_text(size=6))
ggsave("Figures/lernRetrERPs.tiff", dpi = 300, width = 16, height = 8, units = "cm")
```
...
save(search.Init.TO.results, search.Init.TD.results, search.Init.DTnt.results, search.Init.DTpd.results, search.Init.TO.fup, search.Init.TD.fup, search.Init.DTpd.fup, search.Init.TO.aov, search.Init.TD.aov, search.Init.DTnt.aov, search.Init.DTpd.aov, file = "DataOutput/SrchInitERPANOVAs.RData")
```
...
allData %>%
    ...
    theme_apa() +
  theme(text = element_text(size=10))
ggsave("Figures/SrchInitERPs.tiff", dpi = 300, width = 16, height = 8, units = "cm")
```
...
save(search.Extd.TO.results, search.Extd.TD.results, search.Extd.DTnt.results, search.Extd.DTpd.results, search.Extd.TO.fup, search.Extd.TD.fup, search.Extd.DTnt.fup, search.Extd.DTpd.fup, search.Extd.TO.aov, search.Extd.TD.aov, search.Extd.DTnt.aov, search.Extd.DTpd.aov, file = "DataOutput/SrchExtdERPANOVAs.RData")
```
...
allData %>%
    ...
    scale_x_continuous(name ="Latency (ms)", expand = c(0, 0), limits=c(-200, 500), breaks=seq(-200,500,200)) +
    scale_y_reverse(name =expression(paste("Amplitude (",mu,"v)")), expand = c(0, 0)) +
    facet_grid(Stimulus~Group1, labeller = labeller(Stimulus = c("Target (None mid)" = "Target Only", "Target (Distractor mid)" = "Target","Distractor (Target mid)" = "Distractor"))) +
    theme_apa()+
    theme(text = element_text(size=10),
          legend.text = element_text( size = 4),
          legend.title = element_text( size = 4))
ggsave("Figures/SrchExtdERPs.tiff", dpi = 300, width = 16, height = 8, units = "cm")
```
...
allData %>%
    ...
    theme(text = element_text(size=10),
          legend.text = element_text( size = 4),
          legend.title = element_text( size = 4))
ggsave("Figures/SrchExtdERPsNOSUB.tiff", dpi = 300, width = 16, height = 8, units = "cm")
```
...
save(search.Retr.TO.results, search.Retr.TD.results, search.Retr.DTnt.results, search.Retr.DTpd.results, search.Retr.TO.aov, search.Retr.TD.aov, search.Retr.DTnt.aov, search.Retr.DTpd.aov, file = "DataOutput/SrchRetrERPANOVAs.RData")
```
...
allData %>%
    ...
    scale_x_continuous(name ="Latency (ms)", expand = c(0, 0), limits=c(-200, 500), breaks=seq(-200,500,200)) +
    scale_y_reverse(name =expression(paste("Amplitude (",mu,"v)")), expand = c(0, 0)) +
    facet_grid(Stimulus~Group2, labeller = labeller(Stimulus = c("Target (None mid)" = "Target Only", "Target (Distractor mid)" = "Target","Distractor (Target mid)" = "Distractor"))) +
    theme_apa()+
    theme(legend.text = element_text( size = 4),
          legend.title = element_text( size = 4),
          text = element_text(size=6))
ggsave("Figures/SrchRetrERPs.tiff", dpi = 300, width = 16, height = 8, units = "cm")
```

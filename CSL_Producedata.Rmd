...
search.Extd.DTpd.fup <- apa_print.emmGrid(pairs(emmeans(search.Extd.DTpd.aov, ~Contra|Session*Group1)))
```
...
allData %>%
    ...
    theme(text = element_text(size=10),
          legend.text = element_text( size = 4),
          legend.title = element_text( size = 4))
ggsave("Figures/SrchExtdERPsNOSUB.jpg", dpi = 300, width = 5, height = 3, units = c("in"))
```
...
ggsave("Figures/SrchRetrERPs.jpg", dpi = 300, width = 5, height = 2, units = c("in"))
```

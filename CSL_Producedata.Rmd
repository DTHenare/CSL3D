...
behavData %>%
  ...
  theme_apa()
ggsave("Figures/Behav1.tiff", dpi = 123, width = 16, height = 8, units = "cm")
...
behavData %>%
  ...
  theme_apa()
ggsave('Figures/Behav2.tiff', dpi = 123, width = 16, height = 8, units = "cm")
...
behavData %>%
  ...
  coord_cartesian(ylim=c(75,100))+
  theme_apa()
ggsave('Figures/Behav3.tiff', dpi = 123, width = 16, height = 8, units = "cm")
...
ggsave('Figures/Behav4.tiff', dpi = 123, width = 16, height = 8, units = "cm")
...
ggsave("Figures/lernInitERPs.tiff", dpi = 123, width = 16, height = 8, units = "cm")
```
...
ggsave("Figures/lernExtdERPs.tiff", dpi = 123, width = 16, height = 8, units = "cm")
```
...
ggsave("Figures/lernRetrERPs.tiff", dpi = 123, width = 16, height = 8, units = "cm")
```
...
allData %>%
    ...
    theme_apa() +
  theme(text = element_text(size=10))
ggsave("Figures/SrchInitERPs.tiff", dpi = 123, width = 16, height = 8, units = "cm")
```
...
allData %>%
    ...
    theme(text = element_text(size=10),
          legend.text = element_text( size = 4),
          legend.title = element_text( size = 4))
ggsave("Figures/SrchExtdERPs.tiff", dpi = 123, width = 16, height = 8, units = "cm")
```
...
allData %>%
    ...
    theme(text = element_text(size=10),
          legend.text = element_text( size = 4),
          legend.title = element_text( size = 4))
ggsave("Figures/SrchExtdERPsNOSUB.tiff", dpi = 123, width = 16, height = 8, units = "cm")
```
...
allData %>%
    ...
    theme(legend.text = element_text( size = 4),
          legend.title = element_text( size = 4),
          text = element_text(size=6))
ggsave("Figures/SrchRetrERPs.tiff", dpi = 123, width = 16, height = 8, units = "cm")
```
